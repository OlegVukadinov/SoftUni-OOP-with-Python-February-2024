...
# m = MovieApp()
# m.register_user("asd", 12)
# movie = Fantasy("asd", 1996, m.users_collection[0])
#
# m.upload_movie("asd", movie )
#
# m.edit_movie("asd", movie, title = "changed", year = 1998, age_restriction = 15)
