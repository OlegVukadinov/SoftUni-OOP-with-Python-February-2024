...
class TestTrip(TestCase):
    ...
    def test_test_book_a_trip_not_enough_budget(self):
        result = self.t2t.book_a_trip('New Zealand')
        self.assertEqual('Your budget is not enough!', result )

    def test_book_a_trip_succesfully_no_family_discount(self):
    ...
    def test_book_a_trip_succesfully_with_family_discount(self):
