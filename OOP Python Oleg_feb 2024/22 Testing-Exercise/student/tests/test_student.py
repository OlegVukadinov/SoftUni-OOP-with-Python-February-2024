...
class TestStudent(TestCase):
    ...
    def test_enroll_in_the_same_course_append_new_notes(self):
    ...
    def test_enroll_in_new_course_without_third_param_ads_notes_to_the_course(self):
        result = self.student.enroll("math", ["x + y = z"])

        self.assertEqual("Course and course notes have been added.", result)
        self.assertEqual({"math": ["x + y = z"]}, self.student.courses)

    def test_enroll_in_new_course_with_third_param_Y_ads_notes_to_the_course(self):
    ...
    def test_enroll_in_new_course_with_third_param_NO_do_not_add_notes_to_the_course(self):
        result = self.student.enroll("math",
                                     ["x + y = z"],
                                     "n"
                                     )
    ...
    def test_leave_course_expect_unsuccess_raises(self):
        #result = self.student_with_courses.leave_course('math')
        with self.assertRaises(Exception) as ex:
