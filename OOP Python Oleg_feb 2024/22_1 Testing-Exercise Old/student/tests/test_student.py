...
class TestStudent(TestCase):
    ...
    def test_enroll_not_existing_course_with_y(self):
        result = self.student_1.enroll("C#", ["n1", "n1"], add_course_notes="Y")

        self.assertTrue("C#" in self.student_1.courses)
        self.assertEqual("Course and course notes have been added.", result)
        self.assertEqual(["n1", "n1"], self.student_1.courses["C#"])

    def test_enroll_not_existing_course_with_empty_string(self):
        result = self.student_1.enroll("C#", ["n1", "n1"], add_course_notes="")
    ...
    def test_enroll_not_existing_course_not_adding_notes(self):
        result = self.student_1.enroll("C#", ["n1", "n1"], add_course_notes="N")
    ...
    def test_add_notes_to_existing_course(self):
        self.student_2.enroll("C#", ["n1", "n1"])
        result = self.student_2.add_notes("C#", "n3")

        self.assertEqual("Notes have been updated", result)
        self.assertEqual(["n1", "n1", "n3"], self.student_2.courses["C#"])
