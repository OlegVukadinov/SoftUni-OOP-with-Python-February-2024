...
class TestHashTable(TestCase):
    ...
    def test_get_item_key_not_presented_raises(self):
        ...
        self.assertEqual("Key does not exist", (err.exception.args[0]))
    ...
    def test_more_values_than_current_length_resizes_attributes(self):
        self.assertEqual(self.h._HashTable__keys, [None, None, None, None])
        self.assertEqual(self.h._HashTable__values, [None, None, None, None])
        self.assertEqual(self.h._HashTable__length, 4)
        ...
        self.assertEqual(self.h._HashTable__keys, ["number", "name", "age", "street", None, None, None, "new value"])
        self.assertEqual(self.h._HashTable__values, [8, "test", 25, "new street", None, None, None, "hi"])
